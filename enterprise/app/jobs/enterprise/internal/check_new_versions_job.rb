module Enterprise::Internal::CheckNewVersionsJob
  ...
  def update_plan_info
    ...
    update_installation_config(key: 'SyncYou_SUPPORT_WEBSITE_TOKEN', value: @instance_info['SyncYou_support_website_token'])
    update_installation_config(key: 'SyncYou_SUPPORT_IDENTIFIER_HASH', value: @instance_info['SyncYou_support_identifier_hash'])
    update_installation_config(key: 'SyncYou_SUPPORT_SCRIPT_URL', value: @instance_info['SyncYou_support_script_url'])
  end
