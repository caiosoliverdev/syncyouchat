export default {
  ...
  DOCS_URL: '//www.SyncYou.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.SyncYou.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.SyncYou.com/content.json',
