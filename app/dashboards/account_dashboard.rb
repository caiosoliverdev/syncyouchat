...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if SyncYouApp.enterprise?
                                 {
  ...
  enterprise_show_page_attributes = SyncYouApp.enterprise? ? %i[limits all_features] : []
  ...
  enterprise_form_attributes = SyncYouApp.enterprise? ? %i[limits all_features] : []
  FORM_ATTRIBUTES = (%i[
    name
    locale
    status
