module Redis::RedisKeys
  ...
  SyncYou_INSTALLATION_ONBOARDING = 'SyncYou_INSTALLATION_ONBOARDING'.freeze
  SyncYou_INSTALLATION_CONFIG_RESET_WARNING = 'SyncYou_CONFIG_RESET_WARNING'.freeze
  LATEST_SyncYou_VERSION = 'LATEST_SyncYou_VERSION'.freeze
